                    ...
                    <div class="card-body">
                        <div class="box">
                            ...
                            <table class="table table-hover" style="margin-bottom: 0px">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Nombre</th><th>Precio Compra</th><th>Precio Venta</th><th>Probabilidad</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($clase as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->nombre }}</td><td>@if($item->precio_c == 0) - @else {{ $item->precio_c }} @endif</td><td>@if($item->precio_c == 0) - @else {{ $item->precio_v }} @endif</td><td>@if($item->probabilidad == 1) - @else {{ $item->probabilidad*100 }}% @endif</td>
                                        <td>
